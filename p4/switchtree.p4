...
#define GINI_VALUE_THRESHOLD 500
...
control MyIngress(inout headers hdr,
    ...
    **/
    ...
    table table_cmp_feature_tree_1_level_6 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_1_level_7 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_1_level_8 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_1_level_9 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_1_level_10 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_1_level_11 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_6 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_7 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_8 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_9 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_10 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_2_level_11 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_6 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_7 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_8 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_9 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_10 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
    ...
    table table_cmp_feature_tree_3_level_11 {
        key = {
            meta.current_node_id: exact;
            meta.feature_larger_than_thr: exact;
        }
            ...
            if (is_stored_in_buffer) {
                ...
                if (meta.flow.classified == 1) {
                    ...
                    if (meta.flow.features.bidirectional_packets == USED_PACKETS) {
                        ...
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_6.apply();
                        }
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_7.apply();
                        }
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_8.apply();
                        }
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_9.apply();
                        }
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_10.apply();
                        }
                        if (meta.flow.classified_tree_1 == 0) {
                            table_cmp_feature_tree_1_level_11.apply();
                        }
                        ...
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_6.apply();
                        }
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_7.apply();
                        }
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_8.apply();
                        }
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_9.apply();
                        }
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_10.apply();
                        }
                        if (meta.flow.classified_tree_2 == 0) {
                            table_cmp_feature_tree_2_level_11.apply();
                        }
                        ...
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_6.apply();
                        }
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_7.apply();
                        }
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_8.apply();
                        }
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_9.apply();
                        }
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_10.apply();
                        }
                        if (meta.flow.classified_tree_3 == 0) {
                            table_cmp_feature_tree_3_level_11.apply();
                        }
                    }
